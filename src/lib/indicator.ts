...
import { CCI_PERIOD, MFI_PERIOD, RSI_PERIOD, WILLIAMSR_PERIOD } from '../utils/options'
...
export const willliamsR = new WilliamsR({ high: [], low: [], close: [], period: WILLIAMSR_PERIOD })
